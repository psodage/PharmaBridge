...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_message'])) {
    ...
    if (empty($subject) || empty($message)) {
        ...
        $sql = "INSERT INTO admin_messages (sender_id, sender_name, subject, message, priority, status, date_sent) 
                VALUES (?, ?, ?, ?, ?, 'unread', NOW())";
...
if (isset($_SESSION['user_id'])) {
    $sql = "SELECT am.*, ar.response, ar.date_sent as response_date 
            ...
            LEFT JOIN admin_responses ar ON am.message_id = ar.message_id
            WHERE am.sender_id = ?
  ...
  <div class="sidebar" id="sidebar">
    <ul class="menu">
      ...
      <li class="menu-item">
        ...
        <div class="dropdown">
          <a href="#" class="dropdown-item active" data-page="admin.php">Contact Admin</a>
