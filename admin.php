...
<body>
  ...
  <div class="sidebar" id="sidebar">
    <ul class="menu">
      <li class="menu-item">
        <button class="menu-btn active" data-page="admin/home.php">
      ...
      <li class="menu-item">
        ...
        <div class="dropdown show">
          <a href="#" class="dropdown-item " data-page="admin/user_management/manage-pharma-companies.php">View & Manage Pharmaceutical Companies</a>
          <a href="#" class="dropdown-item " data-page="admin/user_management/manage-medical-stores.php">View & Manage Medical Stores</a>
          <a href="#" class="dropdown-item" data-page="admin/user_management/manage-user-status.php">Approve / Suspend / Remove Users</a>
        </div>
      </li>
      <li class="menu-item">
        <button class="menu-btn" onclick="toggleDropdown(this)">
        ...
        <div class="dropdown">
          <a href="#" class="dropdown-item" data-page="admin/monitor-products.php">Monitor Listed Products</a>
         
          <a href="#" class="dropdown-item" data-page="admin/review-orders.php">Review Order Activities</a>
        </div>
      </li>
      ...
      <li class="menu-item">
        ...
        <div class="dropdown">
          <a href="#" class="dropdown-item" data-page="admin/admin-profile.php">Admin Profile Management</a>
      ...
      <li class="menu-item">
        ...
        <div class="dropdown">
        <a href="#" class="dropdown-item" data-page="admin/handle-complaints_medical.php">Handle Complaints From Medical</a>
        <a href="#" class="dropdown-item" data-page="admin/handle-complaints_company.php">Handle Complaints From Company</a>
        </div>
      </li>
      <li class="menu-item">
      ...
      <div class="recent-activity">
        ...
        <div class="activity-list">
          <div class="activity-item">
           ...
           <a href="admin/user_management/manage-pharma-companies.php"> <button class="activity-action">Review</button></a>
          </div>
        ...
        <a href="admin/review-orders.php">  <button class="activity-action">Investigate</button></a>
          </div>
          ...
          <div class="activity-item">
            ...
            <a href="admin/user_management/manage-medical-stores.php"><button class="activity-action">View</button></a>
          </div>
        </div>
      </div>
    </div>
