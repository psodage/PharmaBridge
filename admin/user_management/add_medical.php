...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $checkEmail = "SELECT id FROM medical_users WHERE email = ?";
    ...
    if ($uploadOk) {
        ...
        $sql = "INSERT INTO medical_users (name, email, password, license_number, license_document, approval_status, created_at) 
                VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        if ($stmt->execute()) {
            // Success
            $_SESSION['success'] = "New medical added successfully.";
