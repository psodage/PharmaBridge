...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_status'])) {
    ...
    $updateQuery = "UPDATE company_users SET approval_status = ? WHERE id = ?";
...
<head>
    ...
    <title>Company Details - BridgeRx Admin</title>
...
<div class="header">
  ...
  <div class="header-controls">
    ...
    <div class="sidebar" id="sidebar">
        <!-- Same sidebar as in manage-pharma-companies.php -->
        <ul class="menu">
            <li class="menu-item">
            ...
            <!-- Other menu items (same as manage-pharma-companies.php) -->
            <li class="menu-item">
    ...
    <div class="content" id="content">
        <div id="content-container">
            <div class="content-header">
                <h1 class="content-title">Company Details</h1>
                <div class="content-actions">
                <button class="action-btn back-btn" onclick="window.location.href='manage-pharma-companies.php'">Back to List</button>
            ...
            <div class="company-details">
                ...
                <div class="license-document">
                    ...
                    <?php if (!empty($company['license_document'])): ?>
                        ...
                        <a href="admin/../../<?php echo $company['license_document']; ?>" class="document-link" target="_blank">View Full Document</a>
                    <?php else: ?>
                ...
                <button class="action-btn edit-btn" onclick="window.location.href='edit_company.php?id=<?php echo $company['id']; ?>'">Edit Details</button>

                    <?php if ($company['approval_status'] == 'declined'): ?>
                        <button class="action-btn delete-btn" onclick="deleteCompany(<?php echo $company['id']; ?>)">Delete Company</button>
                    <?php endif; ?>
                </div>
            </div>
        </div>
    ...
    <script>
        // Same sidebar toggle and menu functions as manage-pharma-companies.php
        ...
        function deleteCompany(id) {
            if (confirm('Are you sure you want to delete this company? This action cannot be undone.')) {
                ...
                .then(data => {
                    alert(data);
                    window.location.href = 'manage-pharma-companies.php';
                });
            }
        }
    </script>
