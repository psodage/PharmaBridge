...
if (!isset($_GET['id']) || empty($_GET['id'])) {
    header("Location: manage-pharma-stores.php");
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_medical'])) {
    ...
    $updateQuery = "UPDATE medical_users SET name = ?, email = ?, license_number = ? WHERE id = ?";
    ...
    if (!empty($_FILES['license_document']['name'])) {
        ...
        if ($uploadOk) {
            if (move_uploaded_file($_FILES['license_document']['tmp_name'], $targetFile)) {
                ...
                $updateFileQuery = "UPDATE medical_users SET license_document = ? WHERE id = ?";
    ...
    if ($updateStmt->execute()) {
        ...
        $successMessage = "Medical information updated successfully!";
        ...
        $errorMessage = "Error updating medical information: " . $conn->error;
    }
}
?>
...
<head>
    ...
    <title>Edit Medical - BridgeRx Admin</title>
    <link rel="stylesheet" href="../../css/admin.css">
    <link rel="stylesheet" href="../../css/view_medical.css">
    <style>
        /* Form styles */
        .edit-form {
            background: #fff;
        ...
        <ul class="menu">
            ...
            <li class="menu-item">
                ...
                <div class="dropdown show">
                    <a href="manage-pharma-stores.php" class="dropdown-item ">View & Manage Pharmaceutical Stores</a>
    ...
    <div class="content" id="content">
        <div id="content-container">
            <div class="content-header">
                <h1 class="content-title">Edit Medical</h1>
                <div class="content-actions">
                    <button class="action-btn back-btn" onclick="window.location.href='view_medical.php?id=<?php echo $id; ?>'">Back to Details</button>
                </div>
            </div>
            ...
            <div class="edit-form">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="action-buttons">
                        <button type="submit" name="update_medical" class="action-btn save-btn">Save Changes</button>
                        <button type="button" class="action-btn back-btn" onclick="window.location.href='view_medical.php?id=<?php echo $id; ?>'">Cancel</button>
                    </div>
                </form>
            </div>
        </div>
