...
<head>
  ...
  <title>Admin Dashboard - Pharmaceutical Medical Management</title>
...
<body>
  ...
  $statusQuery = "SELECT DISTINCT approval_status FROM medical_users";
    ...
    <ul class="menu">
      ...
      <li class="menu-item">
        ...
        <div class="dropdown show">
          ...
          <a href="#" class="dropdown-item active" data-page="manage-medical-stores.php">View & Manage Medical Stores</a>
  ...
  <div class="content" id="content">
    <div id="content-container">
      <div class="content-header">
        <h1 class="content-title">Pharmaceutical MedicalManagement</h1>
        <div class="content-actions">
          <button class="action-btn">Add New Medical</button>
        </div>
      </div>

      <div class="search-filters">
        <div class="search-box">
          <input type="text" id="searchInput" placeholder="Search stores..." value="<?= isset($_GET['search']) ? htmlspecialchars($_GET['search']) : '' ?>">
      ...
      <div class="data-table-container">
        <table class="data-table">
          ...
          <tbody>
            ...
            ?>
            <tr>
              <td colspan="7" style="text-align: center;">No medicalfound</td>
            </tr>
            <?php } ?>
          </tbody>
        </table>
  ...
  <script>
    ...
    // Pharmaceutical Medical Management specific functions
    ...
    function viewCompany(id) {
      window.location.href = 'view_medical.php?id=' + id;
    }
  ...
  <!-- Add this right before the closing </body> tag in manage-pharma-stores.php -->

<!-- Add Medical Modal -->
<div id="addCompanyModal" class="modal">
  <div class="modal-content">
    <div class="modal-header">
      <h2>Add New Pharmaceutical Medical</h2>
      <span class="close">&times;</span>
    </div>
    <div class="modal-body">
      <form id="addCompanyForm" method="post" enctype="multipart/form-data" action="add_medical.php">
        <div class="form-group">
          <label for="companyName">Medical Name *</label>
        ...
        <div class="form-actions">
          <button type="submit" class="action-btn">Save Medical</button>
...
<!-- Add this JavaScript to the existing script section in manage-pharma-stores.php -->
<script>
